...
public class Warrior{
  ...
  public Warrior(String name, int rank){
    this.name = name;
    this.rank = rank;
  }
  ...
  public int attack(Warrior enemy){
    return this.rank - enemy.rank;
  }
  // Setter는 필요 없으니 안 만들겠습니다.
  public String getName(){
    return this.name;
  }
...
public class Barbarian extends Warrior{
  ...
  public Barbarian(String name, int rank, String village){
    // Warrior의 name, rank는 private이므로 super()를 통해 가져옵니다. 아래의 경우 부모 class의 constructor를 통해 name과 rank를 지정합니다. this.name this.rank 와 할당 연산자(=) 필요x
    super(name, rank);
