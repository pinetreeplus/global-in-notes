...
<img src="./03-css/css-ruleset.webp" width="500">
...
아래와 같은 property는 inheritance를 관리하며 모든 CSS Property에서 사용가능합니다. [inheritance 예시](./03-css/)
...
[Media query (`@media`)](./03-css/media-query.css) CSS **at-rule**는 하나나 그 이상의 Media query에 기반해 Style Sheet를 적용할 수 있도록 해줍니다.
