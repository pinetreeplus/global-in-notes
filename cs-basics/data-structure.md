...
**[Self Balancing Binary Search Tree](https://en.wikipedia.org/wiki/Self-balancing_binary_search_tree)는 무작위 insertion(추가)와 deletion(삭제)시 height(높이)를 최소화하는 Binary Tree의 총칭입니다**
