...
**[Tree](https://en.wikipedia.org/wiki/Tree_structure)는 hierarchical(수직적인) 구조를 graphical(시각적)하게 표현**하는 방식입니다.
...
**[Heap](https://en.wikipedia.org/wiki/Heap_(data_structure))이란**

### R-B(Red-Black) Tree

<img src="./images/Red-black_tree_example_with_sockets.svg.png" width="500" />

**[Red-Black Tree](https://en.wikipedia.org/wiki/Red%E2%80%93black_tree)는**
